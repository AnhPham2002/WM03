...
typedef enum
{
    EVENT_MAGNETIC_DETECTED = 1,
    EVENT_MAGNETIC_ENDED,
    EVENT_POWER_DETECTED,
    EVENT_POWER_LOST,
    EVENT_LOW_BATTERY,
    EVENT_LOW_BATTERY_RECOVERED,
    EVENT_CONFIG_CHANGED,
    EVENT_PASSWORD_CHANGED,
    EVENT_FIRMWARE_UPDATE_DETECTED,
} Event_Code_t;
 ...
 *
 * @param[in]  u8PasswordLevel Password level.
 * @param[out] pPassword       Password buffer.
 *

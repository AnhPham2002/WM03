...
typedef enum
{
    ...
    PROTOCOL_ERR_PUSH_INFO_SUCCESS = 0x80,
    PROTOCOL_ERR_PUSH_LATCH_SUCCESS = 0x81,
    PROTOCOL_ERR_PUSH_EVENT_SUCCESS = 0x82,
    PROTOCOL_ERR_PUSH_INFO_FAILED = 0x83,
    PROTOCOL_ERR_PUSH_LATCH_FAILED = 0x84,
    PROTOCOL_ERR_PUSH_EVENT_FAILED = 0x85,
    PROTOCOL_ERR_MODULE_SERIAL_INVALID = 0x90,
    PROTOCOL_ERR_NULL_POINTER = 0x91,

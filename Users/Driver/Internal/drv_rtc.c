...
void drv_rtc_init(void)
{
    ...
    drv_rtc_get_date_time(&sDateTime);
    u16RtcAlarmAIsrCount = sDateTime.u8Hours * 60 + sDateTime.u8Minutes;
}
...
uint16_t drv_rtc_get_minutes_of_day(void)
{
    return u16RtcAlarmAIsrCount;
}
...
void HAL_RTC_AlarmAEventCallback(RTC_HandleTypeDef *hrtc)
{
    ...
    if (u16RtcAlarmAIsrCount >= MINUTES_PER_DAY)
    {
        u16RtcAlarmAIsrCount = 0;
    }
}

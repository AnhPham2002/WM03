...
void drv_uart1_init(uint32_t u32Baud, uint32_t u32Parity)
{
    ...
    huart1.Init.WordLength = (u32Parity == UART_PARITY_NONE ? UART_WORDLENGTH_8B : UART_WORDLENGTH_9B);
...
void drv_uart2_init(uint32_t u32Baud, uint32_t u32Parity)
{
    ...
    huart2.Init.WordLength = (u32Parity == UART_PARITY_NONE ? UART_WORDLENGTH_8B : UART_WORDLENGTH_9B);
...
void drv_uart3_init(uint32_t u32Baud, uint32_t u32Parity)
{
    ...
    huart3.Init.WordLength = (u32Parity == UART_PARITY_NONE ? UART_WORDLENGTH_8B : UART_WORDLENGTH_9B);

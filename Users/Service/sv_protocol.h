...
#define PROTOCOL_QUERY_ID_LIST(X)       \
    ...
    X(QUERY_PULSE_METER_DATA, 0x04)     \
    X(QUERY_MODBUS_METER_DATA, 0x05)    \
    X(QUERY_PRESSURE_SENSOR_DATA, 0x06) \
    X(QUERY_LATCH, 0x07)                \
    X(QUERY_EVENT, 0x08)                \

...
static const Protocol_Access_Rule_t ProtocolAccessRuleTable[] = {
    ...
    {CMD_GET, CONFIG_MODULE_ACTIVATION_STATUS, ACCESS_LEVEL_2},
    ...
    {CMD_SET, CONFIG_MODULE_ACTIVATION_STATUS, ACCESS_LEVEL_4},
    ...
    /* CMD_QUERY: 0x03 */
    {CMD_QUERY, QUERY_BOOTLOADER_VERSION, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_FIRMWARE_VERSION, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_POWER_SUPPLY_INFO, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_SIM_NETWORK_INFO, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_PULSE_METER_DATA, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_MODBUS_METER_DATA, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_PRESSURE_SENSOR_DATA, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_LATCH, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_EVENT, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_PUSH_STATUS, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_LOG, ACCESS_LEVEL_3},
    {CMD_QUERY, QUERY_METADATA, ACCESS_LEVEL_3},
